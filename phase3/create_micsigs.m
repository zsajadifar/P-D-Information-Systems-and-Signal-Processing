function [mic,noise,speech,SNR] = create_micsigs(speechfilename,noisefilename,mic_length,mic_num,fs_RIR,RIR_sources,RIR_noise,start)
    ...
    for i=1:speech_num
        ...
        mic_targets(:,:,i)=fftfilt(RIR_sources(:,:,i),speech((start-1)*L+1:(start-1)*L+L));
    end
