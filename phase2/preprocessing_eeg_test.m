...
eeg_1_37 = '/eeg_test_sub_1_37';
eeg_file1=dir(fullfile([folder,eeg_1_37]));
eeg_file1=eeg_file1(4:end);

EEG_test_1_37 = struct([]);

for i=1:37

        %% step1, load data
        eeg_file2=dir(fullfile([folder,eeg_1_37,'/',eeg_file1(i).name,'/'],'*.mat'));
        name ={eeg_file2.name};
...
%             E_cnn = bandpass(E_cnn,[1 32],70);
            ...
            EEG_test_1_37{i,1}.trial{j,1}=rmfield(trial,'RawData');
            EEG_test_1_37{i,1}.trial{j,1}.eegprepro.reg=E_reg;
            EEG_test_1_37{i,1}.trial{j,1}.eegprepro.cnn=E_cnn;
...
save('EEG_test_1_37.mat',"EEG_test_1_37","-v7.3")